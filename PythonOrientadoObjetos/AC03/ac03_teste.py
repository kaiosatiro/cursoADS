...
try:
    ...
    assert confronto.lutar(heroi5, vilao1) == 1
    assert confronto.lutar(heroi5, vilao2) == 1
    assert confronto.lutar(heroi5, vilao3) == 2
    assert confronto.lutar(heroi5, vilao4) == 1

    assert confronto.lutar(heroi6, vilao1) == 1
    assert confronto.lutar(heroi6, vilao2) == 1
    assert confronto.lutar(heroi6, vilao3) == 2
    assert confronto.lutar(heroi6, vilao4) == 1
except AssertionError as erro:
