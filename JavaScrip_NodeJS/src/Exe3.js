/**
 * Escreva uma função que receba dois números inteiros positivos 
 * e devolva a soma de todos
 ...
 * @return {number} o somatório de valores pares entre os dois números, 
 * contando com eles.
